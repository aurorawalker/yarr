...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'Recipe'
        db.create_table(u'kitchen_recipe', (
        ...
        db.send_create_signal('kitchen', ['Recipe'])


    def backwards(self, orm):
        # Deleting model 'Recipe'
        db.delete_table(u'kitchen_recipe')
    ...
    models = {
        ...
        'kitchen.recipe': {
            'Meta': {'ordering': "['created_at']", 'object_name': 'Recipe'},
            ...
            'modified_by': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'modifier'", 'null': 'True', 'to': u"orm['auth.User']"}),
